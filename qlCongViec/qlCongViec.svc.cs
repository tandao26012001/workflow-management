...
{
    public class qlCongViecContext : XpoContext
    {
        public qlCongViecContext(string s1, string s2, IDataLayer dataLayer)
    ...
    [JSONPSupportBehavior]
#endif
    public class qlCongViecService : XpoDataServiceV3
    {
        static readonly qlCongViecContext serviceContext = new qlCongViecContext("qlCongViecService", "qlCongViec", CreateDataLayer());

        public qlCongViecService() : base(serviceContext, serviceContext) { }
